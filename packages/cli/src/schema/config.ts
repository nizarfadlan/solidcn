...
export const DEFAULT_REGISTRY_URL = "https://solidcn.dev/r/{name}.json";
export const DEFAULT_INDEX_URL = "https://solidcn.dev/r/registry.json";
export const DEFAULT_REGISTRIES_URL = "https://solidcn.dev/r/registries.json";
